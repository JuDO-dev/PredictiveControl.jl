...
clqrStablized = createSampleLTISystem( usedare = true, usek = true )
clqrWithS     = createSampleLTISystem( usedare = true, uses = true, usek = true )
...
@test conditionBound( clqrStablized, samplingPoints=10000 ) ≈ 64.7999 atol=1e-4
...
@test conditionBound( clqrTwoInputs, samplingPoints=10000 ) ≈ 12201.000000000648
