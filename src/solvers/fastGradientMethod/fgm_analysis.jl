...
"""
function upperiterationbound( ϵ::Float64, G::AbstractMatrix{Float64}, g::AbstractVector{Float64}; H::AbstractMatrix{Float64} = zeros( Float64, (1,1) ), L::Float64 = eigmax(H), κ::Float64 = cond(H) )
